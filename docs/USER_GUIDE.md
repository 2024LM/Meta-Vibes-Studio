...
> From installation to final export: every feature, control, and recommended production step.
...
Create a project, choose portrait or landscape images, and select a resolution. A project keeps prompts, references, and video tasks together. Use **Choose project** to reopen a saved project folder.
...
- [ ] The project name, orientation, and resolution are correct.
